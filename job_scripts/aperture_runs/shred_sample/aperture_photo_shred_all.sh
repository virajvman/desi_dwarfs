...
shifter --image docker:legacysurvey/legacypipe:DR10.3.4 python3 desi_dwarfs/code/tractor_model.py -sample LOWZ -bkg_source -blend_remove_source -use_sample shred
python3 desi_dwarfs/code/dwarf_photo_pipeline.py -sample LOWZ -min 0 -max 100000 -run_parr -ncores 64 -overwrite -nchunks 5 -run_aper -no_cnn_cut -use_sample shred -run_cog 
...
python3 desi_dwarfs/code/dwarf_photo_pipeline.py -sample BGS_FAINT -min 0 -max 100000 -run_parr -ncores 64 -overwrite -nchunks 5 -run_aper -no_cnn_cut -use_sample shred -run_cog 
...
shifter --image docker:legacysurvey/legacypipe:DR10.3.4 python3 desi_dwarfs/code/tractor_model.py -sample BGS_BRIGHT -bkg_source -blend_remove_source -use_sample shred
python3 desi_dwarfs/code/dwarf_photo_pipeline.py -sample BGS_BRIGHT -min 0 -max 100000 -run_parr -ncores 64 -overwrite -nchunks 20 -run_aper -no_cnn_cut -use_sample shred -run_cog 
...
shifter --image docker:legacysurvey/legacypipe:DR10.3.4 python3 desi_dwarfs/code/tractor_model.py -sample ELG -bkg_source -blend_remove_source -use_sample shred
