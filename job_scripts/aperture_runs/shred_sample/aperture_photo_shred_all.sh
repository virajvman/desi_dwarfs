...
shifter --image docker:legacysurvey/legacypipe:DR10.3.4 python3 desi_dwarfs/code/tractor_model.py -sample LOWZ -parent_source -bkg_source -blend_remove_source -use_sample shred
...
shifter --image docker:legacysurvey/legacypipe:DR10.3.4 python3 desi_dwarfs/code/tractor_model.py -sample BGS_FAINT -parent_source -bkg_source -blend_remove_source -use_sample shred
...
shifter --image docker:legacysurvey/legacypipe:DR10.3.4 python3 desi_dwarfs/code/tractor_model.py -sample BGS_BRIGHT -parent_source -bkg_source -blend_remove_source -use_sample shred
...
shifter --image docker:legacysurvey/legacypipe:DR10.3.4 python3 desi_dwarfs/code/tractor_model.py -sample ELG -parent_source -bkg_source -blend_remove_source -use_sample shred
