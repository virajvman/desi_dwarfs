In this script, we have to code to compute estimated total SFR, fiber based local sSFR, and strong line metallicities. We follow the same prescription as Dirk scholte for computing metallicities, which they validate against the OIII method. We will add this to the FASTSPEC column as it involves properties derived using informtion from FASTSPEC.

code to compute metallicity can be found in metallicity.py
