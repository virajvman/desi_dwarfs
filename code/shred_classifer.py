...
if __name__ == '__main__':
    ...
    if False:
        ...
        if get_all_data:
            ...
            np.save("/pscratch/sd/v/virajvm/catalog_dr1_dwarfs/shred_classifier_output/all_shred_data_N_6_96_96.npy", all_shred_images_unnorm)
            ...
            ##save this data!!
            np.save("/pscratch/sd/v/virajvm/catalog_dr1_dwarfs/shred_classifier_output/all_shred_metadata_scaled.npy", all_metadata_scaled)
