...
# Single-panel overlay variant (plot_spectra_filters_overlay): the two redshifts
# are drawn on ONE axis instead of stacked panels, so these are decoupled from the
